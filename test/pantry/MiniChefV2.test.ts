...
describe("MiniChefV2", function () {
  ...
  describe("Set", function () {
    it("Should emit event LogSetPool", async function () {
      ...
      await expect(this.chief.set(0, 10, this.dummy.address, true)).to.emit(this.chief, "LogSetPool").withArgs(0, 10, this.dummy.address, true)
    })
  ...
  describe("UpdatePool", function () {
    it("Should emit event LogUpdatePool", async function () {
      ...
      await expect(this.chief.updatePool(0))
        ...
        .withArgs(
          0,
          (await this.chief.poolInfo(0)).lastRewardTime,
    ...
    it("Should take else path", async function () {
      ...
      await this.chief.batch(
        [this.chief.interface.encodeFunctionData("updatePool", [0]), this.chief.interface.encodeFunctionData("updatePool", [0])],
        true
      )
    })
  })
